...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '5dec9ab3-9989-433b-bcd4-87d2cbd5b9eb' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('dbcc69c8-5834-4ca0-9b1e-00df8cbfcc84');
      cy.get(`[data-cy="name"]`).should('have.value', 'dbcc69c8-5834-4ca0-9b1e-00df8cbfcc84');
